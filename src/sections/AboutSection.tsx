...
export default function AboutSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Full-viewport pin so the next section can't bleed in underneath
      ...
      <div className="flex min-h-svh items-center pt-22">
        <Container className="w-full px-5 py-20 sm:px-8 lg:px-10">
          <div className="grid items-start gap-6 sm:gap-8 lg:grid-cols-[minmax(0,0.28fr)_minmax(0,0.72fr)] lg:gap-12 xl:gap-16">
            <p className="font-sans text-sm font-normal text-accent-alt sm:text-[15px] lg:pt-2">
              {data.eyebrow}
            </p>

            <h2 className="max-w-4xl font-sans text-[clamp(28px,4.5vw,52px)] font-bold leading-[1.28] tracking-tight text-white/90">
